...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '2a60d4aa21a3465db5b583fdacc22df1',
  PSEUDO_STATIC: process.env.NEXT_PUBLIC_PSEUDO_STATIC || false, // 伪静态路径，开启后所有文章URL都以 .html 结尾。
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 5, // 更新内容缓存间隔 单位(秒)；即每个页面有5秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
  THEME: process.env.NEXT_PUBLIC_THEME || 'simplefacai', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '刘发财', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '何时能发财', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lisky.com.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '刘发财', // 网站关键词 英文逗号隔开
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '刘发财的个人博客', // 站点描述，被notion中的页面描述覆盖
